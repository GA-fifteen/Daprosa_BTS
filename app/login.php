...
if(isset($_REQUEST['as']) && isset($_REQUEST['userName']) && isset($_REQUEST['password'])){
    if($_REQUEST['as'] == "Customer"){
        $verrify = $action->logIn($_REQUEST['userName'],$_REQUEST['password'],$_REQUEST['as']);
        if($verrify){
...
<body class="container">
    ...
    <form class="logIn" method="POST"><br/>
